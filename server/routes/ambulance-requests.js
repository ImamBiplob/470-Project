...
router.delete('/:id', async (req, res) => {
    ...
    const ambulance_request = await Ambulance_request.findByIdAndRemove(req.params.id);

    if(!ambulance_request) return res.status(404).send('The Ambulance Request with the given id not found');
